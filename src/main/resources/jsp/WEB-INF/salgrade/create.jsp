...
<section class="container">
 	<form action="/salgrade/create" method="post">  <!--form은 디폴트가 get방식이라 url에 정보가 담김-->
		<div class="mb-3">
			...
			<input class="form-control"    id="grade" name="grade" placeholder="급여등급을 입력하세요" value="${salgrade.grade}"/>
		</div>
		<div class="mb-3">
			<label class="form-lable mb-2" for="losal">losal</label>
			<input class="form-control"    id="losal" name="losal"   placeholder="최저급여를 입력하세요" value="${salgrade.losal}"/>
		</div>
		<div class="mb-3">
